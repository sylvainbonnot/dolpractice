# Taken from https://github.com/rougier/numpy-100/blob/master/generators.py
...
def create_jupyter_notebook(destination_filename='dol_exercises.ipynb'):
...
def create_markdown(destination_filename='dol_exercises', with_hints=True, with_solutions=True):
    # Create file name
    if with_hints:
